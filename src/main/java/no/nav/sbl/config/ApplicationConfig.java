...
public class ApplicationConfig implements ApiApplication {
    ...
    public static final String KAFKA_BROKERS_URL = "KAFKA_BROKERS_URL";
    ...
    private KafkaConsumerConfig.KafkaConsumerConfigBuilder eventConsumerBuilder() {
        List<KafkaConsumerConfig.BootstrapServer> bootstrapServers = KafkaConsumerConfig.BootstrapServer.parse(EnvironmentUtils.getRequiredProperty(KAFKA_BROKERS_URL));
